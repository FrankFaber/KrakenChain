...
official/supported Docker Images found at https://hub.docker.com/r/krakenchainpay/krakenchaind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/krakenchainpay/krakenchaind-develop/ when changing the above text**