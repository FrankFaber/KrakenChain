...
EXPECTED_HOLDER_NAMES = [
    ...
    "The KrakenChain Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a KrakenChain Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The KrakenChain Core developers'
...
Arguments:
    <base_directory> - The base directory of KrakenChain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the KrakenChain Core repository.
"""
