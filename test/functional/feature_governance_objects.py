...
"""Tests around krakenchain governance objects."""
...
class KrakenChainGovernanceTest (KrakenChainTestFramework):
    def set_test_params(self):
        self.set_krakenchain_test_params(2, 1)
...
if __name__ == '__main__':
    KrakenChainGovernanceTest().main()
