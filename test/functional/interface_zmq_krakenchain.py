...
"""Test the krakenchain specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     KrakenChainTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class KrakenChainZMQTest (KrakenChainTestFramework):
    def set_test_params(self):
        ...
        self.set_krakenchain_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that krakenchaind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all krakenchain related ZMQ publisher
