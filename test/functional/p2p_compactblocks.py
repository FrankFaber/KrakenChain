...
# TestP2PConn: A peer we use to send messages to krakenchaind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes krakenchaind to (reasonably!) disconnect us, so do this last.
    ...
    # krakenchaind's choice of nonce.
    ...
    # Test that krakenchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for krakenchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # krakenchaind will not send blocktxn responses for blocks whose height is
