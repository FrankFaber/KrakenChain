...
/** Utility functions used by the KrakenChain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "krakenchain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load krakenchain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a krakenchain specific theme is activated (light/dark).*/
