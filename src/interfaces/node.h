...
//! Interface for the src/evo part of a krakenchain node (krakenchaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a krakenchain node (krakenchaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a krakenchain node (krakenchaind process).
...
//! Top-level interface for a krakenchain node (krakenchaind process).
class Node
{
public:
    virtual ~Node() {}
