 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1646848341, nBits=1e0ffff0, nNonce=857022, vtx=1)
...
{
    const char* pszTimestamp = "Releasing the Kraken";
    const CScript genesisOutputScript = CScript() << ParseHex("04fc403f0fe44f3000d934a529b15bd048f0f75cfd34523888206b0ca404d84b57d8cce609392d6b2c512ea279472ae7e85cfa27daace3df0e8914708c8d2faadf") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000c317f0d0a3f317388fa17222d162805bd8e472b167299d211de46707483"); 
        ...
        genesis = CreateGenesisBlock(1646848341, 857022, 0x1e0ffff0, 1, 450 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c317f0d0a3f317388fa17222d162805bd8e472b167299d211de46707483"));
        assert(genesis.hashMerkleRoot == uint256S("0x7c2cef2926966270fd9bc666a77e7bcb78c5d2e9fa0f97b6063c503eef7af6f3"));
        ...
        vSeeds.emplace_back("node1.krakenbit.net");
        vSeeds.emplace_back("node2.krakenbit.net");
        ...
        // KrakenChain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // KrakenChain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // KrakenChain BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"KQwky7a4wFZeNxeQXH1WCWtYVKjgAv9nc8"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000c317f0d0a3f317388fa17222d162805bd8e472b167299d211de46707483")},
            }
        };

        chainTxData = ChainTxData{
            1646848341, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000c1cbb1148a4684f55d88267a9c1c5dadb6ed2510e8e75aeeca1c3bf1a1f"); 
        ...
        genesis = CreateGenesisBlock(1646848346UL, 1243501UL, 0x1e0ffff0, 1, 450 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c1cbb1148a4684f55d88267a9c1c5dadb6ed2510e8e75aeeca1c3bf1a1f"));
        assert(genesis.hashMerkleRoot == uint256S("0x7c2cef2926966270fd9bc666a77e7bcb78c5d2e9fa0f97b6063c503eef7af6f3"));
        ...
        // Testnet KrakenChain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet KrakenChain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet KrakenChain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TTZioXczpUi6dAC6kf2GWWw2vBU8U2dVo6"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000c1cbb1148a4684f55d88267a9c1c5dadb6ed2510e8e75aeeca1c3bf1a1f")},
            }
        };

        chainTxData = ChainTxData{
            1646848346, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1646848351, 0, 0x207fffff, 1, 450 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0f918aec1fb123ae490dddc36e68b1990afcf7a4fc895a11f23c49f19f87778a"));
        assert(genesis.hashMerkleRoot == uint256S("0x7c2cef2926966270fd9bc666a77e7bcb78c5d2e9fa0f97b6063c503eef7af6f3"));

        if (!fHelpOnly) {
            devnetGenesis = FindDevNetGenesisBlock(genesis, 450 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x0f918aec1fb123ae490dddc36e68b1990afcf7a4fc895a11f23c49f19f87778a")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7W7FEui2pRPmRuRF46vxPiGyyCNpjuY3NQpTWnWX6LL1bFTgq9A
        vSporkAddresses = {"TZELA6qViN7X3UZFUbxAGzyhDLHhK8qyWb"};
        nMinSporkKeys = 1;
        ...
        // Regtest KrakenChain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest KrakenChain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest KrakenChain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest KrakenChain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest KrakenChain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
