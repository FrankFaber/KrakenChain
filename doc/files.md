...
* krakenchain.conf: contains configuration settings for krakenchaind or krakenchain-qt
* krakenchaind.pid: stores the process id of krakenchaind while running
...
* debug.log: contains debug information and general logging generated by krakenchaind or krakenchain-qt
