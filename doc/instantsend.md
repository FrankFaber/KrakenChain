...
This mechanism has been integrated into Bitcore-Node-KrakenChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/krakenchainpay/insight-api-krakenchain#web-socket-api](https://github.com/krakenchainpay/insight-api-krakenchain#web-socket-api)
* API: [https://github.com/krakenchainpay/insight-api-krakenchain#instantsend-transactions](https://github.com/krakenchainpay/insight-api-krakenchain#instantsend-transactions)
