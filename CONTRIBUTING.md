Contributing to KrakenChain Core
============================

The KrakenChain Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to krakenchain-qt
...
[Translation Process](https://github.com/krakenchainpay/krakenchain/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the KrakenChain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall KrakenChain
Network Protocol consensus changes.

Whether a pull request is merged into KrakenChain Core rests with the project merge
...
Patches that change KrakenChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the KrakenChain consensus, it must have been
...
The review process is normally fairly responsive on the KrakenChain Core repository, however
...
The project leader is the release manager for each KrakenChain Core release.
